...
// Number of images requested on each API call is 21. Each API call returns new images even with page reloads.
...
// ADDED IN PAGE NAME AND EMOJI: own name and emoji Added to the website
